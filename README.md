...
Welcome to the **Xr Ar Industrial Maintenance Overlay** repository. This project is built to deliver a robust and scalable solution tailored to modern development standards.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Shivay00001/xr-ar-industrial-maintenance-overlay.git
   ```
2. Navigate to the project directory:
   ```bash
   cd xr-ar-industrial-maintenance-overlay
   ```
